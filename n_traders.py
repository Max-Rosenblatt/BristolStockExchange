...
for buyer_type in buyer_types:
    ...
    plt.plot(times, best_bids, label='Best Bid Price', color='blue', marker='.', linestyle='')
    plt.plot(times, best_asks, label='Best Ask Price', color='darkseagreen', marker='.', linestyle='')
    plt.xlabel('Time (s)')
    plt.ylabel('Prices (£)')
